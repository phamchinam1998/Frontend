...
//         const element = document.getElementById('main-image');
//         let i = parseInt(element.getAttribute('order'))
//         if (i === arr.length - 1) {
//             i = 0;
...
//                         <div id="img-main">
//                             <div id="main-image-container" className="img" >
//                                 <img id='main-image' order={0} src={PIMG1} alt="" />
//                             </div>
//                         </div>
//                         <div id="carousel-img">
//                             <div className="carousel-item">
//                                 <img role="button" onClick={() => { setURL(0, PIMG1) }} className="img-carousel" id="img-0" src={PIMG1} alt="" />
//                             </div>
//                             <div className="carousel-item">
//                                 <img role="button" onClick={() => { setURL(1, PIMG2) }} className="img-carousel" id="img-1" src={PIMG2} alt="" />
//                             </div>
//                             <div className="carousel-item">
//                                 <img role="button" onClick={() => { setURL(2, PIMG3) }} className="img-carousel" id="img-2" src={PIMG3} alt="" />
//                             </div>
//                         </div>
//                     </div>